...
install("blaze-hot");
install("static-html");
install("akryum:vue-component-dev-server", "meteor/akryum:vue-component-dev-server/server/main.js");
install("autoupdate", "meteor/autoupdate/autoupdate_server.js");
install("akryum:vue-component-dev-client");
install("akryum:vue-component");
install("akryum:npm-check");
install("akryum:vue");
...
install("peerlibrary:middleware", "meteor/peerlibrary:middleware/server.coffee");
install("alanning:roles");
install("lacosta:method-hooks");
...
install("socialize:server-presence", "meteor/socialize:server-presence/server-presence.js");
...
install("socialize:server-time", "meteor/socialize:server-time/server/server-time.js");
install("socialize:base-model", "meteor/socialize:base-model/entry-meteor.js");
install("socialize:linkable-model", "meteor/socialize:linkable-model/common/common.js");
install("socialize:user-model", "meteor/socialize:user-model/common/common.js");
install("socialize:user-presence", "meteor/socialize:user-presence/server/server.js");
...
meteorInstall({"node_modules":{"firebase-admin":{"package.json":function module(require,exports,module){
...
}}},"mimetypes":{"package.json":function module(require,exports,module){

/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                                     //
// node_modules/mimetypes/package.json                                                                                 //
//                                                                                                                     //
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                       //
module.exports = {
  "name": "mimetypes",
  "version": "0.1.1",
  "main": "src/mimetypes.js"
};

/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

},"src":{"mimetypes.js":function module(require,exports,module){
