module.export({MeteorData:()=>MeteorData,MeteorSub:()=>MeteorSub});var commonjsGlobal = typeof window !== 'undefined' ? window : typeof global !== 'undefined' ? global : typeof self !== 'undefined' ? self : {};
...
var CMeteorSub = {
  ...
  watch: {
    name: 'updateSub',
    parameters: function parameters(value, oldValue) {
      if ((typeof value === 'undefined' ? 'undefined' : _typeof(value)) !== (typeof oldValue === 'undefined' ? 'undefined' : _typeof(oldValue))) this.updateSub();
    }
  },
        ...
        $_subscribe: function $_subscribe() {
          ...
          if (args.length > 0) {
            ...
            if (typeof handle.ready === 'function') {
              set$1(this.$data.$meteor.subs, key, false);
...
var MeteorData = CMeteorData;
var MeteorSub = CMeteorSub;
