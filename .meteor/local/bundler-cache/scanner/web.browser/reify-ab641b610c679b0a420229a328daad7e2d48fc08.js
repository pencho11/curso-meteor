module.export({MockStorage:()=>MockStorage,VuexPersistence:()=>VuexPersistence});let deepmerge;module.link('deepmerge',{default(v){deepmerge=v}},0);
...
// @ts-ignore
{
    module.runSetters(MockStorage = class {
        get length() {
...
module.exportDefault(VuexPersistence);
